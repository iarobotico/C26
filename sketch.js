...
function setup() {
	...
	rope1=new rope(bob1.body,{x:320,y:250})
	rope2=new rope(bob2.body,{x:360,y:250})
	rope3=new rope(bob3.body,{x:400,y:250})
	rope4=new rope(bob4.body,{x:440,y:250})
	rope5=new rope(bob5.body,{x:480,y:250})
...
//WRITE A CORRECT CODE TO APPLY A KEYPRESSED TO CHANGE THE POSITION OF BALL OBJECT TO THE LEFT WHEN UP ARROW KEY IS PRESSED
	Body.applyForce(bob1.body,bob1.body.position,{x:-1,y:-1.5})
	}
}
